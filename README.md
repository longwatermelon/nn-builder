...
- The **editor** is the central workbench and has two synchronized panes: the **network view** (embedded layer controls + visual graph + neuron selection) and the **neuron inspector** (numeric controls for the selected neuron).
